...
class Funcs():
    ...
    def add_aluno(self):
        ...
        self.cursor.execute(""" INSERT INTO alunos (nome_alunos, nota1, nota2)
    ...
    def select_lista(self):
        ...
        self.conecta_bd()
        lista = self.cursor.execute(""" SELECT cod, nome_alunos, nota1, nota2 FROM alunos
            ORDER BY nome_alunos ASC; """)
        for i in lista:
...
class Application(Funcs):
    ...
    def widgets_frame1(self):
        ...
        self.bt_limpar = Button(self.frame_1, text= "Limpar", bd=2, bg = '#107db2',fg = 'white'
                                , font = ('verdana', 8, 'bold'), command= self.limpa_alunos)
        ...
        ## Criação da label e entrada da nota1
        ...
        ## Criação da label e entrada da nota2
    ...
    def lista_frame2(self):
        ...
        self.listaAlu.column("#3", width=50)
        self.listaAlu.column("#4", width=50)
